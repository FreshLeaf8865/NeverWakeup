...
import {TouchableHighlight, TouchableOpacity, LayoutAnimation, ScrollView, Dimensions, View, Image, Text} from "react-native";
...
export default class ImageInfoModal extends Component {
  ...
  render() {
    ...
    if(this.state.loaded){
      var slides = [];
      var description = <View style={[styles.modalInfoContainer, {height:Dimensions.get('window').height-80,overflow:'hidden'}]} key='description'>
                          <ScrollView >
